...
contract ZKoupon is ERC721A, Ownable, IZKoupon, ZKouponStorage {
  ...
  function redeemCoupon(
    ...
    require(
      couponList[_commitment].redeemed <= couponList[_commitment].maxAmount,
  ...
  function getCommitmentFromTokenId(uint256 _tokenId)
    external
    view
    override
    returns (uint256)
  ...
  function getCouponInfoWithCommitment(uint256 _commitment)
    external
    view
    override
